...
const SignUp = () => {
  const [isRegularEyeOpen, setIsRegularEyeOpen] = useState(false);
  ...
  const handleRegularEyeOpen = () => {
    setIsRegularEyeOpen(!isRegularEyeOpen);
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-2">
            ...
            <div>
              ...
              <input
                ...
                className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
                placeholder="y@gmail.com"
              />
            </div>
            <div className="relative">
              <label className="font-medium">Password</label>
              <input
                type={isRegularEyeOpen ? "text" : "password"}
                id="password"
                required
            ...
            <div className="relative">
              ...
              />
              <span
                onClick={handleConfirmPasswordOpen}
                className="absolute top-11 right-2"
              >
                {isConfirmEyeOpen ? (
                  <Eye className="w-5 h-5 text-indigo-500" />
